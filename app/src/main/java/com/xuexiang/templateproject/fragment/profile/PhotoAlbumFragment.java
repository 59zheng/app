...
@Page(anim = CoreAnim.present,name = "我的相册")
public class PhotoAlbumFragment extends BaseFragment {
    ...
    protected void initViews() {
        ...
        recyclerView.setAdapter(mAdapter = new PhotoAlbumAdapter(DemoDataProvider.getMyPhoto()));
    ...
    protected void initListeners() {
        ...
        refreshLayout.setOnRefreshListener(refreshLayout -> {
            ...
            refreshLayout.getLayout().postDelayed(() -> {
                mAdapter.refresh(DemoDataProvider.getMyPhoto());
        ...
        refreshLayout.setOnLoadMoreListener(refreshLayout -> {
            // TODO: 2020-02-25 这里只是模拟了网络请求
            refreshLayout.getLayout().postDelayed(() -> {
                mAdapter.loadMore(DemoDataProvider.getMyPhoto());
